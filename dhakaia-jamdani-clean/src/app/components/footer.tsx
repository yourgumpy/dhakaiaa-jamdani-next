  ...
  return (
    <footer className="bg-gray-900 dark:bg-black text-white">
      ...
      <div className="container mx-auto px-4 py-16">
            ...
            >
              ...
              <div className="flex flex-col md:flex-row gap-6">
                ...
                <div className="flex-1">
                  ...
                  <div className="relative w-max h-48 rounded-lg overflow-hidden border border-gray-700">
                    <iframe
                ...
                <div className="flex-1 flex flex-col">
                  ...
                  <motion.div
                    ...
                    transition={{ duration: 0.6 }}
                    viewport={{ once: true }}
                    className="w-[700px] bg-gradient-to-r from-red-500 to-orange-500 p-6 rounded-lg"
                  >
        ...
        >
          <div className="flex items-center gap-6 mb-6 sm:mb-0"></div>
